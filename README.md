...
About the Project
This project is a web application that recommends cooking recipes based on ingredients available with the user and the time limit provided. Users upload images of ingredients, and the system uses AI to detect them and generate suitable recipes using Large Language Models and an AI agent. The application helps users save time, reduce food wastage, and make quick cooking decisions.

Problem Statement
Users often find it difficult to decide what to cook with limited ingredients and time. Existing platforms require manual ingredient input and lack intelligent personalization. This project addresses these issues using image-based ingredient detection and AI-driven recipe generation.
...
-Personalized recommendations -Easy and user-friendly interface
...
User initiates request via the frontend.
Backend coordinates with image recognition and AI components.
AI agent and LLM generate personalized recipes.
Results are stored and delivered back to the user.
Continuous feedback improves personalization and performance. what slides should we put for ppt 
